...
import org.learning.multithreading.multithreading.workers.CSVFileHandler2;
...
public class CallableStrategy extends BaseThread implements ThreadStrategy {

    public CallableStrategy(Map<String, Object> config) {
        super(config);
    }
