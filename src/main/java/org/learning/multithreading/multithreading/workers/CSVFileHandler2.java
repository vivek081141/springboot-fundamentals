package org.learning.multithreading.multithreading.workers;

import org.learning.multithreading.multithreading.basics.User;
...
public class CSVFileHandler2 implements Callable<String> {
    public String inputFile;
    public String outPutFile;

    @Override
    public String call() throws Exception {
        return csvFileEditor(inputFile,outPutFile);
    }

    public String csvFileEditor(String file,String outPutFile){
